define("flxSmsMessage", function() {
    return function(controller) {
        var flxSmsMessage = new kony.ui.FlexContainer({
        ...
        flxSmsMessage.setDefaultUnit(kony.flex.DP);
        var flxTempRowWrapper = new kony.ui.FlexContainer({
            "autogrowMode": kony.flex.AUTOGROW_NONE,
            "clipBounds": true,
            "height": "100%",
            "id": "flxTempRowWrapper",
            "isVisible": true,
        ...
        flxTempRowWrapper.setDefaultUnit(kony.flex.DP);
        var flxMarkRead = new kony.ui.FlexContainer({
            ...
            "layoutType": kony.flex.FREE_FORM,
            "left": "0%",
            "onClick": controller.AS_FlexContainer_b8f44d27d7874ae5bf7df47b15904bae,
            "skin": "slFbox",
            "width": "14%",
            "zIndex": 1
        }, {}, {});
        ...
        var flxDelRow = new kony.ui.FlexContainer({
            ...
            "layoutType": kony.flex.FREE_FORM,
            "left": "0%",
            "onClick": controller.AS_FlexContainer_bc5b68e343aa476481e8bc46e8a18a9a,
            "skin": "slFbox",
            "width": "14%",
            "zIndex": 1
        }, {}, {});
        ...
        flxTempRowWrapper.add(flxMarkRead, flxRowWrapper, flxDelRow);
        flxSmsMessage.add(flxTempRowWrapper);
        return flxSmsMessage;
    }
})