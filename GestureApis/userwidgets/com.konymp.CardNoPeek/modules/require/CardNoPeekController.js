define(function() {
  ...
  return {
    mapValue : function(){
      var data = [{
        "imgSlide" :"kony_mp_carousel2_slides1.png" ,
        ...
        "imgSlide" :"kony_mp_carousel2_slides2.png" ,
        ...
        "imgSlide" :"kony_mp_carousel2_slides3.png" ,
        ...
        "imgSlide" :"kony_mp_carousel2_slides4.png" ,
      ...
      this.view.segCarousel2.setData(data);
      this.view.mapView.zoomLevel = 7;
      this.onSwipe(0);
    },
    onSwipe : function(row){
      var data = this.view.segCarousel2.data[row];
