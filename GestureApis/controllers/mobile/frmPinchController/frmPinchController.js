define({ 
 ...
 //Type your controller code here 
	...
	onPinchClosure:function(widgetRef,gestureInfo){
 ...
 // var e = gestureInfo.swipeDirection ;
      ...
      if(g_scaleEnd > g_scaleStart)
        {
          ...
          this.view.Image0b8a22e54f53b46.animate(
  ...
  addPinchGesture:function(){
    var pinchConfig={fingers :2,continuousEvents :true};
     this.view.flxPinch.addGestureRecognizer(constants.GESTURE_TYPE_PINCH,pinchConfig,this.onPinchClosure);
  }
 });